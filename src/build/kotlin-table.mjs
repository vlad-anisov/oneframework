 ...
 *
 * В ядре, а не у питоновской привязки: с 02.09.2026 таблица не порождается
 * питоном, а лежит данными и читается всеми тремя одинаково. Порождать из неё
 * исходник для третьего языка -- работа ядра; пока это делал питон, поправить
 * таблицу и пересобрать Kotlin без питона было нельзя.
 *
