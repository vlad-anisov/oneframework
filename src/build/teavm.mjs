 ...
 *
 * Раньше это жило на питоне и было удалено 21.08.2026: шаг не питоновский --
 * собрать модуль просит **пакет объявления** (действие с разделом `wasm`), а
 * объявить такое может приложение на любом языке. Пока сборка модулей жила в
 * питоновском пакете, человек с приложением на Kotlin ставил питон ради того,
 * чтобы скомпилировать свой же Kotlin.
 *
