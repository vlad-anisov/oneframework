/**
 * Разворот: документ плюс данные -- дерево. Было парой к `oneframework/ui/expand.py` (удалён 21.08.2026).
 *
...
/**
 * Одна подстановка как текст. Было парой к `_part` в `oneframework/ui/expand.py, удалён`.
 *
