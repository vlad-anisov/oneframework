 ...
 *
 * Было парой к развороту в `oneframework/ui/expand.py` (удалён 21.08.2026); ответ
 * обязан совпадать вплоть до
 * того, как выглядит булево значение и во что превращается отсутствующее, --
 * иначе один и тот же документ даст на двух машинах разный текст, а это не
 * ошибка, а просто другая надпись, которую никто не заметит.
 */
