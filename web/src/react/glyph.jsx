 ...
 *
 * Пары у него больше нет. Рядом лежал `icons.js` -- он отдавал строку разметки
 * для мест, где Framework7 просил строку, -- и 20.08.2026 обход достижимости
 * показал, что таких мест не осталось ни одного: всё рисуется отсюда. Шестнадцать
 * строк убраны.
 *
