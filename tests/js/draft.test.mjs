 ...
 *
 * Спрашивается тот рантайм, что стоит на устройстве. До 21.08.2026
 * спрашивался питоновский эталон: у него был свой `Draft`, и совпадение двух
 * держала сверка -- так доказывалось согласие копий, но не верность
 * работающей. Проверка переписана с питона: он остался только оснасткой --
 * объявлял подопытное приложение и говорил с рантаймом через хост.
 */
