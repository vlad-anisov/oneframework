 ...
 *
 * Раньше эти правила держались с двух сторон: питоновский сервер и сверка круг
 * в круг. Оба убраны 20.08.2026 -- вторая реализация всего обмена признана
 * слишком дорогой. Значит этот файл теперь единственный, кто их держит, и
 * мерить он обязан не «работает», а **каждое правило поимённо**.
 *
