 ...
 * живая половина.
 *
 * Арифметика проверяется отдельно от обрыва и без часов. До 20.08.2026
 * счётчик уменьшался на **вызов** сторожа, а не на шаг: предел был в тысячу
 * раз выше названного -- 20 миллиардов шагов вместо 20 миллионов, -- и
 * убегающий запрос резался через 177 секунд. Ровно то «зависло», от которого
 * предел и заводили.
 */
