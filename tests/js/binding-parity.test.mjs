 ...
 * к **питоновской** привязке (`tests/together/test_dsl.py`, `tests/together/test_declaration.py`).
 * Другие держались сверкой документов -- `tests/together/test_three_languages.py`, -- а
