...
(`libs/js/src/core/runtime/db.js`). Сверка была настоящей, пока писали обе. С 21.08.2026
пишет одна -- базу приложения собирает `libs/js/src/build-db.mjs`, -- и сверять
стало не с чем.
