 ...
 *
 * Была половиной перекрёстного теста; питоновская половина удалена 21.08.2026
 * как вторая запись того же правила. Теперь это единственная реализация, и
 * ожидания записаны в проверке литералами, а не сняты у соседа.
 *
