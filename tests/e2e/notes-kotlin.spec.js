 ...
 * (её вели, пока сборщик переезжал) говорила лишь, что два сборщика выдали одно;
...
test("7. на черновике кнопка действия погашена, а не молчит", async ({ page }) => {
  // Прежде она оставалась живой и **ничего не делала**: логика исправно
...
//: питоновским DSL (`test_expr_text.py`), провод -- в `tests/js/expr-text-wire.test.mjs`,
